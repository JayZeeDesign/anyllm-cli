...
const RATE_LIMIT_ERROR_MESSAGE_CLAUDE =
  '\nPlease wait and try again later. To increase your limits, upgrade your Anthropic plan, or switch to another /auth method';
...
function getRateLimitMessage(authType?: AuthType): string {
  switch (authType) {
    ...
    case AuthType.USE_CLAUDE:
      return RATE_LIMIT_ERROR_MESSAGE_CLAUDE;
    default:
